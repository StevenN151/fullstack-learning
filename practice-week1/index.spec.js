describe('Practice Week 1 - JS basic', function () {
  ...
  it('checkExamResult should return "Pass" or "Fail" ', function () {
  ...
  it('getGrade function should return the right grade ', function () {
  ...
  it('getNumbersLargerThanTen should return an array containing all numbers larger than 10 ', function () {
